		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Navigation",
									"targetURL": "#zbtpday6exerise3delarosa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday6exerise3delarosa-display": {
								"semanticObject": "zbtpday6exerise3delarosa",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day6exerise3delarosa",
									"url": sap.ui.require.toUrl("zbtp/day6exerise3delarosa")
								}
							}
						}
					}
